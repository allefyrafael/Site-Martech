...
export default function TechUnionSolutionsPageVariant2() {
  ...
  return (
    <div className="flex min-h-screen flex-col" key="TechUnionSolutionsVariant2">
      {/* JSON-LD Structured Data */}
      <Script
        id="tech-union-solutions-schema-variant2"
                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-0">
                  ...
                  <div className="md:col-span-3 p-4 sm:p-6 md:p-8 flex flex-col">
                    ...
                    <div className="mb-4 md:mb-8">
                     ...
                     <a href="https://hotm.art/hDgXtW" target="_blank" rel="noopener noreferrer" className="block w-full">
