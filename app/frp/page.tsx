    ...
    <div className="flex min-h-screen flex-col" key="MartechTeam-frp">
      ...
      <main className="flex-1">
        ...
        <section className="py-16 bg-black relative" id="precos">
          ...
          <div className="absolute -bottom-10 left-1/3 w-72 h-72 bg-green-500/5 rounded-full blur-3xl"></div>
          ...
          <div className="container relative z-10">
            <div className="text-center max-w-3xl mx-auto mb-12">
              <Badge className="bg-gradient-to-r from-green-500 to-green-400 text-black font-bold mb-4 px-4 py-1.5">
                INVESTIMENTO
              </Badge>
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {/* Premium Plan */}
              <div className="bg-gradient-to-b from-green-900/30 to-black border border-green-500/30 rounded-xl overflow-hidden transform transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_10px_30px_rgba(34,197,94,0.3)]">
                <div className="bg-gradient-to-r from-green-500 to-green-400 py-2 px-4">
                ...
                <div className="p-6">
                  <div className="text-center mb-6">
                    ...
                    <div className="text-4xl font-bold text-green-400 mb-2">R$ 490,00</div>
            ...
            {/* Guarantee section */}
            <div className="mt-12 max-w-3xl mx-auto bg-green-900/20 border border-green-500/30 rounded-xl p-6 flex flex-col md:flex-row items-center gap-6">
          ...
          <div className="absolute bottom-0 left-0 w-full overflow-hidden">
            <div className="relative h-12">
              ...
              <div className="absolute -bottom-5 left-1/2 transform -translate-x-1/2 w-1/2 h-12 bg-gradient-to-b from-green-500/10 to-transparent blur-xl"></div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-black relative">
          ...
          <div className="absolute -top-20 left-1/4 w-72 h-72 bg-green-500/5 rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 right-1/3 w-64 h-64 bg-green-500/5 rounded-full blur-3xl"></div>
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-green-600 via-green-500 to-green-400"></div>

          <div className="container relative z-10">
            <div className="max-w-4xl mx-auto bg-gradient-to-b from-green-900/30 to-black border border-green-500/30 rounded-xl p-8 md:p-12 text-center">
              <Badge className="bg-gradient-to-r from-green-500 to-green-400 text-black font-bold mb-6 px-4 py-1.5">
              ...
              <div className="mb-8">
                ...
                <div className="flex justify-center gap-4">
                  <div className="bg-green-900/30 border border-green-500/30 rounded-lg px-4 py-2 text-center min-w-[70px]">
                    <span className="text-2xl font-bold text-green-400">{countdown.days}</span>
                    <p className="text-xs text-gray-400">Dias</p>
                  </div>
                  <div className="bg-green-900/30 border border-green-500/30 rounded-lg px-4 py-2 text-center min-w-[70px]">
                    <span className="text-2xl font-bold text-green-400">{countdown.hours}</span>
                    <p className="text-xs text-gray-400">Horas</p>
                  </div>
                  <div className="bg-green-900/30 border border-green-500/30 rounded-lg px-4 py-2 text-center min-w-[70px]">
                    <span className="text-2xl font-bold text-green-400">{countdown.minutes}</span>
                    <p className="text-xs text-gray-400">Min</p>
                  </div>
                  <div className="bg-green-900/30 border border-green-500/30 rounded-lg px-4 py-2 text-center min-w-[70px]">
                    <span className="text-2xl font-bold text-green-400">{countdown.seconds}</span>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6">
                ...
                >
                  <div className="absolute -inset-0.5 bg-gradient-to-r from-green-500 to-green-400 rounded-lg blur opacity-75 group-hover:opacity-100 transition duration-200"></div>
                  <Button className="relative bg-gradient-to-r from-green-500 to-green-400 hover:from-green-400 hover:to-green-500 text-black font-bold px-8 py-6 text-lg shadow-lg transition-all duration-300">
